...
export default function footer() {
  return (
    ...
    <p onClick={()=> {document.location.pathname='/about'}}> About</p>
        ...
        <a style={{color:"white"}} href="mailto:zaimo3869@gmail.com">
          <FontAwesomeIcon style={{height: "4vh"}} icon={faEnvelope}></FontAwesomeIcon></a>
          <a href="https://www.linkedin.com/in/zaim-bouarfa-b81506193/">
